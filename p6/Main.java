...
public class Main {
    ...
    static void test2(){
        ...
        System.out.println("Construcao de allZeros(3) : " + FenwickTree.allZeros(4));
        System.out.println("Construcao de allZeros(3) : " + FenwickTree.allZeros(5));
        System.out.println("Construcao de allZeros(3) : " + FenwickTree.allZeros(6));
    }
    ...
    static void test3(){
        ...
        FenwickTree T1 = new FenwickTree(3, new FenwickTree(1, new FenwickTree(4),
                    new FenwickTree(1, new FenwickTree(2), new FenwickTree(5))),
                    new FenwickTree(1, new FenwickTree(3), new FenwickTree(1,
                            new FenwickTree(6), new FenwickTree(1))));
        System.out.println("́ Arvore this : " + T1);
    ...
    static void test4(){
        // teste de correcao
        System.out.println("Verificacao de correcao da funcao...");
        FenwickTree T = new FenwickTree(3, new FenwickTree(1, new FenwickTree(0),
